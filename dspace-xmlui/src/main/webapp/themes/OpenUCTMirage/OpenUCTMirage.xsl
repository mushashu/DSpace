...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
	...
	<xsl:template name="disable_front_page_community_browse" match="dri:div[@id='aspect.artifactbrowser.CommunityBrowser.div.comunity-browser']">
    ...
    <xsl:template name="disable_front_page_body_search" match="dri:div[@id='aspect.artifactbrowser.FrontPageSearch.div.front-page-search']">
   </xsl:template>
